...
export default function LandingPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-neutral-950 px-6 py-12">
      {/* Background Blobs */}
      <div className="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-purple-600/20 blur-[100px]" />
      <div className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-blue-600/20 blur-[100px]" />
      ...
      >
        ...
        <h1 className="bg-gradient-to-b from-white to-neutral-400 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-6xl">
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          <button
            ...
            className="group relative flex items-center justify-center gap-3 rounded-full bg-white px-8 py-4 text-sm font-semibold text-black transition-all hover:bg-neutral-200"
          >
            <img src="https://www.google.com/favicon.ico" alt="Google" className="h-5 w-5" />
            Continue with Google
            <Sparkles className="h-4 w-4 text-purple-600 transition-transform group-hover:scale-125" />
          </button>
